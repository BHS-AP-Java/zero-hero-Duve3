...
/*
 * DESCRIPTION: The store class that is used to make stores that sell items
 * INPUT: You can buy items from the store
 * OUTPUT: You can get the items you bought
 * EDGE CASE: Shortage of items!
 */
